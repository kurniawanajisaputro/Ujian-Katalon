...
WebUI.verifyElementText(findTestObject('Page_Swag Labs/div_1'), '1')
...
WebUI.verifyElementText(findTestObject('Page_Swag Labs/span_Checkout Overview'), 'Checkout: Overview')
